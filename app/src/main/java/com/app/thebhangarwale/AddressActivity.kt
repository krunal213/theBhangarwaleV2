...
class AddressActivity : BhangarwaleConfigAndControllerActivity(), View.OnLongClickListener, View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        recyclerviewAddress.apply {
            ...
            adapter = AddressAdapter(myaddress,this@AddressActivity,this@AddressActivity)
    ...
    class AddressAdapter(
        ...
        val onClickListener: View.OnClickListener?) : RecyclerView.Adapter<AddressViewHolder>() {

        override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): AddressViewHolder {
            val view = LayoutInflater.from(parent.context).inflate(R.layout.adapter_address,parent,false)
