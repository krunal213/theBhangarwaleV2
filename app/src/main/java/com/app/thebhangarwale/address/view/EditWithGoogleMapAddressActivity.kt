...
@RuntimePermissions
class EditWithGoogleMapAddressActivity : BhangarwaleConfigAndControllerActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_edit_address_with_google_map)
    ...
    fun initLocation() {
        locationRequest.apply {
            ...
            LocationSettingsRequest.Builder()
                ...
                .apply {
                    LocationServices
                        .getSettingsClient(this@EditWithGoogleMapAddressActivity)
                            ...
                            if (it is ResolvableApiException) {
                                try {
                                    it.startResolutionForResult(
                                        this@EditWithGoogleMapAddressActivity,
                                        REQUEST_MY_LOCATION
                                    )
    ...
    private fun setLocationOnMap() {
        LocationServices
            .getFusedLocationProviderClient(this@EditWithGoogleMapAddressActivity)
                                ...
                                locationResult.locations[0]?.apply {
                                    with(supportFragmentManager.findFragmentById(R.id.map) as SupportMapFragment) {
                                        getMapAsync { mMap ->
                                            ...
                                            mMap?.setMapStyle(MapStyleOptions.loadRawResourceStyle(this@EditWithGoogleMapAddressActivity,
                                                R.raw.style_json
                                            ))
