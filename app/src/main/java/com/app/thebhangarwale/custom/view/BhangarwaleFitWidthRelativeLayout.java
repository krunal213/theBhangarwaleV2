...
public class BhangarwaleFitWidthRelativeLayout extends RelativeLayout {
    ...
    public BhangarwaleFitWidthRelativeLayout(Context context) {
        super(context);
    }

    public BhangarwaleFitWidthRelativeLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public BhangarwaleFitWidthRelativeLayout(Context context, AttributeSet attrs, int defStyleAttr) {
